...
namespace GestionDocumental.Controllers
{
    public class StatesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdState,Name,Description,Active")] State state)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdState,Name,Description,Active")] State state)
        {
            if (ModelState.IsValid)
            {
